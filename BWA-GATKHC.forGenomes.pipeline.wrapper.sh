...
# Modified: Atma Ivancevic, 17/05/2017, tranlsating to SLURM
...
for p in $prefixList; do
	OUTPREFIX=$p SEQPATH=$SEQPATH WORKDIR=$WORKDIR sbatch BWA-GATKHC.forGenomes.q
done
